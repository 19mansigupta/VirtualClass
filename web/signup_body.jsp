<div class="container">
    ...
    <form class="form-horizontal" action="Action?registerstudent=true" method="post">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-4">Student ID:</label>
            <div class="col-md-6 col-sm-6">
                <input type="text" class="form-control" name="studentid" placeholder="Enter Student ID" required>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-4">Phone Number: </label>
            <div class="col-md-6 col-sm-6">
                <input type="tel" class="form-control" name="phonenumber" placeholder="Enter Phone Number" required>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-4">Date of Birth:</label>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-4">Fathers Name:</label>
            <div class="col-md-6 col-sm-6">
                <input type="text" class="form-control" name="fathersname" placeholder="Enter Fathers Name" required>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-4">Mothers Name: </label>
            <div class="col-md-6 col-sm-6">
                <input type="text" class="form-control" name="mothersname" placeholder="Enter Mothers Name" required>
            </div>
        </div>
        <div class="form-group">
